...
public class NightLifeAttractionTests
{
    ...
    private static readonly OwnerAccount DummyOwner =
        new OwnerAccount("NightLifeAttractionOwner", "ValidPassword123", "validemail@pjwstk.edu.pl");
    ...
    public void SetUpEnvironment()
    {
        ...
        _valid = new NightLifeAttraction(Owners, ValidName, ValidLocation, _validOpenTime, _validCloseTime,
